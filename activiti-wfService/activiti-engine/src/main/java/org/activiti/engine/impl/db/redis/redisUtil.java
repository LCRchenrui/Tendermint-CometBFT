...
// import org.springframework.data.redis.connection.RedisSocketConfiguration; 删除
...
public class redisUtil {
    ...
    public StringRedisTemplate getstringRedisTemplate() {
        // RedisStandaloneConfiguration redisConfiguration=new RedisStandaloneConfiguration("localhost", 6379);删掉
        // redisConfiguration.setDatabase(0);删掉
        
        // LettuceConnectionFactory connectionFactory=new LettuceConnectionFactory(new RedisSocketConfiguration("/home/sunweekstar/redis/redis.sock")); 删除这个增加下面的

        // 新增*
        String redisHost = System.getenv().getOrDefault("WF_REDIS_HOST", "127.0.0.1");
        int redisPort = Integer.parseInt(System.getenv().getOrDefault("WF_REDIS_PORT", "6379"));
    ...
    public synchronized static StringRedisTemplate getTableRedisClient() {
        ...
        // RedisStandaloneConfiguration redisConfiguration=new RedisStandaloneConfiguration("localhost", 6379);删掉
        // redisConfiguration.setDatabase(1);删掉
