...
// wfConsensusBridge的网关，核心作用是把外部请求转发到wfEngine，同时记录请求日志
// 把外部请求转成对Nacos或内部转发逻辑的调用


// 对应/grafana/run，是核心的“服务调用入口”，校验关键字段：s-serviceName、s-url、s-method，调g.forward()做真正的服务发现+转发，这是替代旧的wfService/grafana/run的入口
...
// 对应/grafana/serviceRegister，是服务注册入口，调g.nacos.RegisterInstance()做真正的服务注册，用于注册实例到Nacos
